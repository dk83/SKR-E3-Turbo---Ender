...
#define STRING_CONFIG_H_AUTHOR "(Daniel, Ender-3)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 0   //DaKa: Neccessary for TFT release-xx.27 !!!
 ...
 */
#define BAUDRATE 115200   //DaKa: Neccessary for TFT release-xx.27 !!!
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1   //DaKa: Neccessary for TFT release-xx.27 !!!
 ...
 * :[3, 4, 5, 6]
 */
//#define LINEAR_AXES 3   //DaKa: NEW FUNCTION for try, Marin says: NOT FOR PRODUCTION USE (12-07-2021)
...
#define PSU_NAME "BTT Relay V1.2"
  ...
  #define PSU_ACTIVE_STATE HIGH      //DaKa: CHANGED from LOW to HIGH for BTT Relay V1.2  // Set 'LOW' for ATX, 'HIGH' for X-Box
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
      // DaKa: PID TUNE for Drangonfly HOTEnd with Target 75°C
      // Example set manual PID settings:   M301 P29.31 I3.88 D55.42
      #define DEFAULT_Kp 22.9836
      #define DEFAULT_Ki 1.7323
      #define DEFAULT_Kd 76.2366
  #endif
#endif // PIDTEMP
 ...
 */
#define PIDTEMPBED  // DaKa: Optimzed for Ender-3 Bed Heating
 ...
 */
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current  // DaKa: ENABLED
  ...
  //DaKa: PID Auto Tune for 70°C
  #define DEFAULT_bedKp 55.1047
  #define DEFAULT_bedKi 10.8367
  #define DEFAULT_bedKd 186.8048
...
//#define USE_ZMIN_PLUG   // DaKa: DISABLED - Test without this option, because BL-Touch is endstop
...
//#define ENDSTOPPULLUPS    // DaKa DISABLE - if DISABLE then Endstop for ZMIN_PROBE ?!? )But i use Probe Pin?!=)
  ...
  #define ENDSTOPPULLUP_ZMIN_PROBE    //DaKa: ENABLED for BL-Touch v3.1
#endif
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false    //DaKa: CHANGED from false to true // Set to true to invert the logic of the probe.
...
//#define Z2_DRIVER_TYPE TMC2209   //DaKa: ENABLE this fpr second Z-Motor
...
//#define E1_DRIVER_TYPE TMC2209   //DaKa: ENABLE this fpr second E-Motor
...
#define CLASSIC_JERK                        // DaKa Prusaslicer - Good settings { X, Y, Z, E}
  ...
  #define DEFAULT_ZJERK  0.5        // DaKa:CHANGED from 0.3 to 0.5
  //#define DEFAULT_IJERK  0.3
  //#define DEFAULT_JJERK  0.3
  //#define DEFAULT_KJERK  0.3

  #define TRAVEL_EXTRA_XYJERK 2.0    //DaKa: ENABLED and CHANGED from 0.0 to 2.0   // Additional jerk allowance for all travel moves

  #define LIMITED_JERK_EDITING       //DaKa: ENABLED  // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // ~BL-Touch V3.1~

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING   //DaKa: ENABLED
 ...
 */
//#define Z_MIN_PROBE_PIN P1_22     //DaKa: USELESS is defined in pins_SKR_E3_TURBO.h  ~BL-Touch V3.1~ P1_22 is SKR E3 Turbo Default Probe Pin
 ...
 */
#define BLTOUCH    //DaKa: ENABLED ~BL-Touch V3.1~
 ...
 */
#define MULTIPLE_PROBING  2    //DaKa: ENABLED
#define EXTRA_PROBING     1    //DaKa: ENABLED
...
#define Z_MIN_PROBE_REPEATABILITY_TEST   //DaKa: ENABLED for TFT35-E3-V3
...
#define Z_HOMING_HEIGHT  5        //DaKa: ENABLED and CHANGED from 4 to 5 mm  // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

#define Z_AFTER_HOMING   5             //DaKa: ENABLED and CHANGED from 0 to 5mm height after Homeing// (mm) Height to move to after homing Z
...
// DaKa -> CR-10S Hotend-Nozzle Measurement(Left Top Corner):  X: 3.1mm  Y: -3.3mm
// The size of the print bed               // DaKa: YOUR OWN SETTINGS
#define X_BED_SIZE 235   //   DaKa: BED_SIZE = MAX_POS - MIN_POS
#define Y_BED_SIZE 235

// Travel limits (mm) after homing          // DaKa: YOUR OWN SETTINGS (Positive Value: Nozzzle on Bed, Negative Value Nozzle Outside Bed)
#define X_MIN_POS 4.2
#define Y_MIN_POS -7.2
#define Z_MIN_POS 0
// DaKa: Max_Pos = _Bed_Size - Min_Pos (+ "Outside Bed Area")    // DaKa: YOUR OWN SETTINGS
#define X_MAX_POS 250.5    // Daka: Hotend can reach outside Bed Positions -> Use for Brush Holder (Nozzle Clean Feature)
#define Y_MAX_POS 229.6
 ...
 */
#define RESTORE_LEVELING_AFTER_G28   // DaKa: ENABLED for BILINEAR && UBL  -LEVELING
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 20.0 // (mm) Default fade height.    //DaKa: Activate in TFT35->config.ini ?
  #endif
   ...
   */
  #define G26_MESH_VALIDATION  //DaKa: ENABLED and SETTINGS CHANGED for PETG (SUNLU PETG)
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID    //DaKa: ENABLED

    //
    // Experimental Subdivision of the grid by Catmull-Rom method.
    // Synthesizes intermediate points to produce a more detailed mesh.
    //
    #define ABL_BILINEAR_SUBDIVISION    //DaKa: ENABLED
  ...
  #define MESH_INSET 25          //DaKa: CHENGED from 10 to 25 mm // Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 3    // Don't use more than 7 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define MESH_G28_REST_ORIGIN    //DaKa: ENABLED  // After homing all axes ('G28' or 'G28 XYZ') rest Z at Z_MIN_POS
...
#define LCD_BED_LEVELING    //DaKa: ENABLED  (BUT IS THIS USEFULL?)
  ...
  #define MESH_EDIT_MENU            //DaKa: ENABLED  // Add a menu to edit mesh points
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LEVEL_BED_CORNERS    //DaKa: ENABLED  

#if ENABLED(LEVEL_BED_CORNERS)
  #define LEVEL_CORNERS_INSET_LFRB { 30, 30, 30, 50 } //DaKa: CHANGED from { 30, 30, 30, 30 } to { 30, 30, 30, 50 } // (mm) Left, Front, Right, Back insets
  #define LEVEL_CORNERS_HEIGHT      0.1   //DaKa: CHANGED from 0.0mm to 0.1mm (for sheet compensation) // (mm) Z height of nozzle at leveling points
  #define LEVEL_CORNERS_Z_HOP       4.0   // (mm) Z height of nozzle between leveling points
  #define LEVEL_CENTER_TOO             //DaKa: ENABLED // Move to the center after the last corner
  #define LEVEL_CORNERS_USE_PROBE      //DaKa: ENABLED for BL-Touch v3.1
  #if ENABLED(LEVEL_CORNERS_USE_PROBE)
    #define LEVEL_CORNERS_PROBE_TOLERANCE 0.1
    #define LEVEL_CORNERS_VERIFY_RAISED   // After adjustment triggers the probe, re-probe to verify
    #define LEVEL_CORNERS_AUDIO_FEEDBACK   //DaKa: ENABLED
  #endif
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 Z10 F6000\nG1 X5 Y210\n"   //DaKa: ENABLED and CHANGED from "G1 Z10 F12000\nG1 X15 Y330\nG1 Z0.5\nG1 Z10"   to   "G1 Z10 F6000\nG1 X5 Y210\n"
...
//
#define Z_SAFE_HOMING    //  DaKa: ENABLED for  BL-Touch V3.1
...
//#define SKEW_CORRECTION  //  DaKa:  ENABLE for your Own Settings
  ...
  #define SKEW_CORRECTION_GCODE   //DaKa: ENABLED (PREPARED FOR EASY CHANGE the SKEW CORRCTIOn
#endif
 ...
 */
#define EEPROM_SETTINGS       //DaKa: ENABLED    // Persistent storage with M500 and M501
 ...
 */
#define NOZZLE_PARK_FEATURE      //DaKa: ENABLED   ofr TFT35-E3-V3
 ...
 */
#define PRINTCOUNTER   //DaKa: ENABLED
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN     //DaKa: CHANGED from JAPANESE to WESTERN
 ...
 */
#define SDSUPPORT    //DaKa: ENABLED for TFT35-E3-V3
...
//
// !!!--->>>   DaKa: Currently not supported in Marlin 2.0.8   <<<---!!!
//#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER   //DaKa:  ENABLED for SKR TFT35 E3 v3
...
//
#define CR10_STOCKDISPLAY    //DaKa: ENABLED USEFULL for:  TFT35 E3 V3   ->   Marlin MODE
...
#define NEOPIXEL_LED    //DaKa: ENABLED
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE   NEO_GRB //DaKa: CHANGED from NEO_GRBW to GRB (BUT IS THIS OKAY?)   // NEO_GRBW / NEO_GRB - four/three channel driver type (defined in Adafruit_NeoPixel.h)
  //#define NEOPIXEL_PIN     4     //DaKa: USELESS, Pins in file PINS_SKR_E3_TURBO.h definited  // LED driving pin
  //#define NEOPIXEL2_TYPE NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    5
  #define NEOPIXEL_PIXELS 10       //DaKa: CHANGED from 30 Leds to 10 Leds// Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  #define NEOPIXEL_IS_SEQUENTIAL   // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS 127  // Initial brightness (0-255)
  #define NEOPIXEL_STARTUP_TEST      //DaKa: ENABLED  // Cycle through colors at startup
  ...
  #define NEOPIXEL_BKGD_INDEX_FIRST  4            //DaKa: ENABLED and CHANGED from LED Nr. 5 to Nr.4  // Index of the first background LED
  #define NEOPIXEL_BKGD_INDEX_LAST   5            //DaKa: ENABLED // Index of the last background LED
  #define NEOPIXEL_BKGD_COLOR { 0, 64, 0, 0 } //DaKa: ENABLED and CHANGED from { 255, 255, 255, 0 }   to   { 0, 64, 0, 0 } (25% Power on for Green Led) // R, G, B, W
