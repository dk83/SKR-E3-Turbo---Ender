...
#define I2C_EEPROM
// ONBoard EEPROM
//    #define MARLIN_EEPROM_SIZE   0x1000  //DaKa: ONBOARD  EEPROM->   4KB  (AT24C32)

// External EEPROM
#define MARLIN_EEPROM_SIZE   0x7FFF  //DaKa: EXTERNAL EEPROM->  32KB (AT24C256) - Bigtreetech EEPROM V1.0
//
// Servos
//
...
// Temperature Sensors
//
// --->>>   DaKa: Changed Temp_PIN:  P0_24  is defect  -> switched to  P0_23   <<<---//
#define TEMP_0_PIN                         P0_23   //DaKa:  Original HOTend0 is PIN P0_23
//#define TEMP_1_PIN                         P0_23   //DaKa:  Original HOTend1 is PIN P0_24
#define TEMP_BED_PIN                       P0_25
//DaKa:  Add ONBOARD MAINBOARD Temperatur Sensor (Pin 1.30)
#define TEMP_CHAMBER_PIN                   P1_30    //DaKa: I use the name "TEMP_CHAMBER_PIN" for "MAINBOARD ONBOARD TEMP SENSOR" !!!
...
#define FAN1_PIN                           P2_02
  ...
  #define CONTROLLER_FAN_PIN               P1_30
#endif
